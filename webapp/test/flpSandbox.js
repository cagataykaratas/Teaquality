			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"teaquality-display": {
								"semanticObject": "teaquality",
								"action": "display",
								"description": "Teaquality App",
								"title": "Teaquality",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=teaquality",
									"url": sap.ui.require.toUrl("teaquality")
								}
							}
						}
					}
